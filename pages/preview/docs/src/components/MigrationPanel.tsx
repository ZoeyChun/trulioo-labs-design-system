      ...
      <div className="tds-preview__migration">
        ...
        <section className="tds-preview__migration-section">
          ...
          <ul className="tds-preview__migration-list">
            <li><strong>Overview</strong> — chapter description and anatomy demos</li>
            <li><strong>Variants</strong> — sizes, states, positions, and configurations</li>
            <li><strong>Props</strong> — aggregated <code>.ds-api</code> class references</li>
            <li><strong>Tokens</strong> — token dependencies (or link to Foundations)</li>
            <li><strong>A11y</strong> — keyboard, focus, and ARIA guidance</li>
            <li><strong>Code</strong> — copy-ready HTML from demos</li>
          </ul>
          <p>
