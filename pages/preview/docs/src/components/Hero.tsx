...
export function Hero({ features, onExplore, onSearchNavigate, searchOpen, onSearchOpen, onSearchClose }: HeroProps) {
  return (
    <section className="tds-preview__hero">
      ...
      <div className="tds-preview__hero-inner">
        <div className="tds-preview__hero-badge">
          ...
          Trulioo Design System · ADS 2026
        </div>
        <h1 className="tds-preview__hero-title">
          Find any component,
          <br />
          <span className="tds-preview__hero-title-accent">instantly.</span>
        </h1>
        <p className="tds-preview__hero-lead">
          Search across Getting Started guides, Foundations, and the full component library.
          Every <code>tds-</code> class mapped 1:1 from Figma.
        </p>
        <GlobalSearch variant="hero" open={searchOpen} onClose={onSearchClose} onOpen={onSearchOpen} onNavigate={onSearchNavigate} />
        <div className="tds-preview__hero-actions">
          ...
          <a href="https://www.figma.com/design/aMXWPoPQ94hxTKOhUngOih/Trulioo-ADS---2026" target="_blank" rel="noopener noreferrer" className="tds-preview__hero-secondary">
            Open in Figma
          </a>
        </div>
        <div className="tds-preview__hero-highlights">
          ...
          <div className="tds-preview__hero-grid">
            {(features.length ? features : HERO_FEATURES).map((feature, i) => (
              <article key={feature.title} className="tds-preview__hero-card" style={{ animationDelay: `${240 + i * 80}ms` }}>
