/**
 * TruAI chat — vanilla JS panel for static KYB Results page.
 */
(function () {
  "use strict";
  ...
  function navigateTab(tabId) {
    ...
    var tab = document.querySelector('.tds-tab-item[data-kyb-tab="' + tabId + '"]');
    if (tab) tab.click();
  }
    ...
    var thinking =
      state.phase === "thinking"
        ? '<div class="labs-truai-thinking">' +
          ...
          (response ? response.thinkingLabel : "Analyzing entity data…") +
          "</span></div>"
        : "";
  ...
  function setOpen(next) {
    ...
    if (els.toggleBtn) els.toggleBtn.classList.toggle("app-truai-btn--active", next);
    if (els.toggleBtn) els.toggleBtn.setAttribute("aria-expanded", next ? "true" : "false");
  ...
  function panelMarkup() {
    return (
      ...
      '<input type="text" placeholder="Ask about this entity..." aria-label="Ask about this entity" />' +
      "</div>" +
  ...
  function init() {
    ...
    els.toggleBtn = document.getElementById("app-truai-btn");
    if (els.toggleBtn) {
      els.toggleBtn.setAttribute("aria-controls", "labs-truai-chat-rail");
