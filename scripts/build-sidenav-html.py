...
LABS_ICONS = (
    f'<svg class="icon tds-labs-icon tds-labs-icon--onlight" width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">'
    f'<path d="{LABS_PATH}" fill="#617269"/></svg>'
    f'<svg class="icon tds-labs-icon tds-labs-icon--ondark" width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">'
